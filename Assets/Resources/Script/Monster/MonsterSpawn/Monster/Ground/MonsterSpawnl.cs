...
//-----------------------------------------------------------------------------------------
public class MonsterSpawnl : MonoBehaviour  // 이것은 주인공이 발사하는 직선형 스킬을 구현한 스크립트 이다.
{
    ...
    private readonly MonsterDataBaseScript monsterData;

    public Transform[] MapLocation;   // 미사일이 발사될 위치
