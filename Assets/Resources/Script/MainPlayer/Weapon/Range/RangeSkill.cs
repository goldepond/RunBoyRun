...
//-----------------------------------------------------------------------------------------
public class RangeSkill : MonoBehaviour  // 이것은 주인공이 발사하는 직선형 스킬을 구현한 스크립트 이다.
{
    ///=============================================================================================
    public GameObject PlayerMissile;    // 복제할 미사일 오브젝트
    ///=============================================================================================
    public Transform MissileLocation;   // 미사일이 발사될 위치
    public float FireDelay = 4;         // 미사일 발사 속도(미사일이 날라가는 속도x)

    ///=============================================================================================
    public bool FireState;              // 미사일 발사  제어할 변수
    ...
    private readonly GameObject mp;
    ///============================================================================================= 
    ///
